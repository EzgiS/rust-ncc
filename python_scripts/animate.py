...
file_name = "../output/separated_pair_cil=60_cal=None_adh=3_coa=24_seed=1234_rt.cbor"
...
cell_ani.save('separated_pair_cil=60_cal=None_adh=3_coa=24_seed=1234_rt.mp4',
              writer=writer)