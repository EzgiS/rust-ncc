...
file_name = "../output/separated_pair_cil=60_cal=None_adh=None_coa=24_seed=7_rt.cbor"
...
cell_ani.save('separated_pair_cil=60_cal=None_adh=None_coa=24_seed=7_rt.mp4',
              writer=writer)